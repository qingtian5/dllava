...
cfg=stage3_llava_mindgpt_moe_siglipdino_lora_e1_gpu8_finetune_multisubimages_ocr_sft
echo ${cfg}
LOG_FILE=/mnt/pfs-mc0p4k/cv/team/lishanshan/data/code_repo/Friday_SFT/xtuner-new-lishanshan/work_dirs/logs_mindgpt_ocr_sft/${cfg}_${RANK}.log
echo ${LOG_FILE}
