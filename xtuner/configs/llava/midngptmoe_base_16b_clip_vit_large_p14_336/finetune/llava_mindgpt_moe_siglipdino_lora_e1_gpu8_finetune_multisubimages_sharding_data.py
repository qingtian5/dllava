...
pretrained_pth = './work_dirs/llava_mindgpt_moe_siglipdino_lora_e1_gpu8_finetune_multisubimages/mindgpt-moe-2.0-32k-vicuna-siglipdino-123m-tiktoken-ft-allinone/model.bin.iter6690'
...
data_path = '/mnt/pfs-mc0p4k/cv/team/yanghongfu/sharding_data/0809_all_sft_971k_538kgen_100knlu'
# data_path = '/mnt/pfs-mc0p4k/cv/team/yanghongfu/sharding_data/toy'
image_folder = ''

prompt_template = PROMPT_TEMPLATE.mindgpt
max_length = int(1024 * 4 - 256 * 7)

num_sub_images = 6

work_dir = './work_dirs/llava_mindgpt_moe_siglipdino_lora_e1_gpu8_finetune_multisubimages/mindgpt-moe-2.0-32k-vicuna-siglipdino-123m-tiktoken-ft-allinone-back-mindgpt-sft'
