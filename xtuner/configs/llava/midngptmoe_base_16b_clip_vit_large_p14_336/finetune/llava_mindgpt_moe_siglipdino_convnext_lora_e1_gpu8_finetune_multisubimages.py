...
convnext_visual_encoder_name_or_path = '/mnt/pfs-guan-ssai/cv/yanghongfu/CLIP-convnext_xxlarge-laion2B-s34B-b82K-augreg-soup/open_clip_pytorch_model.bin'

# Specify the pretrained pth
pretrained_pth = './work_dirs/llava_dolphin_yi_34b_siglipdino_336_e1_gpu8_pretrain/dolphinyi34b-siglipdino-100m_doc_ocr_gr/iter_19306.pth'
...
# data_path = '/mnt/pfs-guan-ssai/cv/moxu/data/sharding_data/the_cauldron_merge_two_images_without_multihiertt'
# data_path = '/mnt/pfs-mc0p4k/cv/team/yanghongfu/sharding_data/the_cauldron_internvl1.5_ocrcn_grcn'
# image_folder = ''

prompt_template = PROMPT_TEMPLATE.qwen_chat
# max_length = int(2048 - (448 / 14)**2)
# max_length = int(4096 - (448 / 14)**2)
max_length = int(4096 - 256 * 7)

num_sub_images = 6

work_dir = './work_dirs/llava_dolphin_yi_34b_siglipdino_convnext_lora_e1_gpu8_finetune_multisubimages/dolphinyi34b-siglipdino-convnext-558k-ft'
