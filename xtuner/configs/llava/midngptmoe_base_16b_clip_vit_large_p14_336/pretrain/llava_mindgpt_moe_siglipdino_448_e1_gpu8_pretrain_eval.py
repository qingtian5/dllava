...
# llm_name_or_path='/mnt/pfs-guan-ssai/cv/sunhaoyi/MindGPT2.0-32K'
...
pretrained_pth = './work_dirs/llava_mindgpt_moe_siglipdino_448_e1_gpu8_pretrain/mindgpt-moe-chat-siglipdino-558k-tiktoken/iter_437.pth'
...
# data_path = data_root + 'LLaVA-Pretrain/blip_laion_cc_sbu_558k_with_allava_laion_vflan_evol_sharegpt4v.json'
...
work_dir = './work_dirs/llava_mindgpt_moe_siglipdino_448_e1_gpu8_pretrain/mindgpt-moe-chat-siglipdino-558k-tiktoken-eval'
...
tokenizer = dict(
    ...
    pretrained_model_name_or_path='/mnt/pfs-mc0p4k/cv/team/yangchengmin/0722_task_ov/mindgpt-xmodal/data/converted_hf_models/xtuner_ckpt_validation_1',
