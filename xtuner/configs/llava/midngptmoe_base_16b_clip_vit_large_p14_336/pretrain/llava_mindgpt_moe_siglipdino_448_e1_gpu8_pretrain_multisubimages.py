...
pretrained_pth = "/mnt/pfs-guan-ssai/cv/yanghongfu/xtuner-main/work_dirs/llava_mindgpt_moe_siglipdino_448_e1_gpu8_pretrain_thumbnail/sft-mindgpt-v7moe-siglipdino-448-sw-minimonkey-img-slice-300m-stage1/iter_33768.pth/"
...
# data_path = '/mnt/pfs-mc0p4k/cv/team/yanghongfu/sharding_data/llava_300m_sft_doc_gr_ocr_high_resolution_672'
# image_folder = ''
...
work_dir = './work_dirs/llava_mindgpt_moe_siglipdino_448_e1_gpu8_pretrain_multisubimages/sft-mindgpt-v7moe-siglipdino-448-sw-minimonkey-img-slice-300m-stage2-test'
...
tokenizer = dict(
    ...
    pretrained_model_name_or_path='/mnt/pfs-mc0p4k/cv/team/yanghongfu/xtuner_ckpt_validation_1',
