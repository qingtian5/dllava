...
pretrained_pth = './work_dirs/llava_dolphin_yi_34b_radio_large_p16_768_e1_gpu8_pretrain/dolphinyi34b-dino-l-558k-naive-resolution/iter_6977.pth/'
...
max_length = int(4096 - 576)

# num_sub_images = 6

work_dir = './work_dirs/llava_dolphin_yi_34b_radio_lora_e1_gpu8_finetune_dynamic_images/dolphinyi34b-dino-l-558k-naive-resolution-ft'
...
image_processor = dict(
    type=Dynamic_CV_CLIPImageProcessor.from_pretrained,
...
llava_dataset = dict(
    ...
    tokenizer=tokenizer,
    dynamic_image_processor=image_processor,
