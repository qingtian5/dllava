...
from xtuner.utils import Dynamic_CV_CLIPImageProcessor as DynamicCLIPImageProcessor

from xtuner.dataset import LLaVADataset, LLaVADynamicImagesDataset
...
from xtuner.model import LLaVAModel, LLaVAPlusModel
...
siglip_visual_encoder_name_or_path= '/mnt/pfs-guan-ssai/cv/yanghongfu/siglip-so400m-patch14-384'

# Specify the pretrained pth
pretrained_pth = './work_dirs/llava_dolphin_yi_34b_siglip_radio_448_768_e1_gpu8_pretrain_multisubimages/dolphinyi34b-siglip-radio-448-384-dualpathprojector/epoch_1.pth'
...
max_length = int(3 * 1024 - 576 - 256 * 6)

num_sub_images = 6

work_dir = './work_dirs/llava_dolphin_yi_34b_siglip_radio_448_768_e1_gpu8_finetune_multisubimages/dolphinyi34b-siglip-radio-448-384-dualpathprojector-ft'
...
dynamic_image_processor = dict(
    type=DynamicCLIPImageProcessor.from_pretrained,
...
square_image_processor = dict(
    ...
    pretrained_model_name_or_path=siglip_visual_encoder_name_or_path,
    trust_remote_code=True,
    crop_size=448, 
    size=448
)
