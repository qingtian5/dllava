...
pretrained_pth = './work_dirs/llava_dolphin_yi_34b_siglip_convnext_448_1024_e1_gpu8_pretrain/dolphinyi34b-siglip-convnext-channel-fusion-minimokey(2 6)/iter_1163.pth/'
...
work_dir = './work_dirs/llava_dolphin_yi_34b_siglip_convnext_lora_e1_gpu8_finetune_multisubimages/dolphinyi34b-siglip-convnext-channel-fusion-minimokey(2 6)-ft'
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        ...
        # paramwise_cfg=dict(
        #     custom_keys={
        #         'visual_encoder': dict(lr_mult=0.01),
        #         'convnext_visual_encoder': dict(lr_mult=0.01)}),
