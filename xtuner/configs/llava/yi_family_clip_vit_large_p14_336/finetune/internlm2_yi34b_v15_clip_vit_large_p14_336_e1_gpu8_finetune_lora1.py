...
pretrained_pth = "/mnt/pfs-guan-ssai/cv/moxu/xtuner-main/work_dirs/yi_34b_qlora_alpaca_enzh_e3/pretrain/epoch_5.pth"
...
data_path = "/mnt/pfs-guan-ssai/cv/moxu/xtuner-main/data/llava_data/LLaVA-Instruct-150K/llava_v1_5_mix665k.json"
...
warmup_ratio = 0.03
work_dir = '/mnt/pfs-guan-ssai/cv/moxu/xtuner-main/work_dirs/internlm2_yi34b_v15_clip_vit_large_p14_336/finetune/lora1-665k/'
...
model = dict(
    ...
    visual_encoder_lora=dict(
        type=LoraConfig, r=256, lora_alpha=512, lora_dropout=0.03, bias='none'),
        )
