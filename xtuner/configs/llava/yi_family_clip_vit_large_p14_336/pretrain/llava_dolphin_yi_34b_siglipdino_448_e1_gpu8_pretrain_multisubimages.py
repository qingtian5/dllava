...
from xtuner.model import LLaVAModel, LlamaForCausalLM_VoteMix, LlamaForCausalLM_PDrop
...
work_dir = f'./work_dirs/llava_dolphin_yi_34b_siglipdino_448_e1_gpu8_pretrain_multisubimages/dolphinyi34b-siglipdino-{dynamic_image_size}-minimonkey-sharehb1-imgslice-imagegroup'
...
model = dict(
    ...
    llm=dict(
        ...
        # type=LlamaForCausalLM_VoteMix.from_pretrained,
        # type=LlamaForCausalLM_PDrop.from_pretrained,
        pretrained_model_name_or_path=llm_name_or_path,
        trust_remote_code=True,
...
llava_dataset = dict(
    ...
    max_num=max_tiles,
    min_num=min_tiles,
    sampler_name='ImageGroupedSampler',
