...
from xtuner.model.siglipdino_vit import DinoSigLIPViTModel, DinoSigLIPViTConfig
...
# data_path = '/mnt/pfs-guan-ssai/cv/moxu/data/sharding_data/llav558k_hy540k'
...
work_dir = './work_dirs/llava_mindgptv6_16b_eva_vit_large_p14_336_e1_gpu8_pretrain/mindgptv6-26000-siglipdino-prismatic-vlms'
...
model = dict(
    ...
    visual_encoder=dict(
        type=DinoSigLIPViTModel,
        config=dict(
            type=DinoSigLIPViTConfig,
