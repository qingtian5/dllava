...
def main():
    ...
    llava='/mnt/pfs-mc0p4k/cv/team/jucic/xtuner/work_dirs/llava_dolphin_yi_34b_siglipdino_lora_e1_gpu8_finetune_multisubimages/dolphinyi34b-siglipdino-123m-ft-0820_all_sft_1489k_538kgen_100knlu_total-sharding/iter_6205_hf'
    ...
    inputs = prompt_text[1:]

    inputs = inputs.replace('<|im_start|>', '[unused0]').replace('<|im_end|>', '[unused1]')
    print(f"inputs: {[inputs]}")
    
    image_path = '/mnt/pfs-guan-ssai/cv/yanghongfu/xtuner-main/duiqi.jpg'
